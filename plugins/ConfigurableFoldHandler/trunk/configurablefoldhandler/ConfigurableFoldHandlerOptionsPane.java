...
public class ConfigurableFoldHandlerOptionsPane extends AbstractOptionPane
{
	...
	public ConfigurableFoldHandlerOptionsPane()
	{
		...
		defStartField = new JTextField(jEdit.getProperty(
			...
			ConfigurableFoldHandlerPlugin.DEFAULT_FOLD_STRINGS
				.getStartString()));
			...
			if (oldStr == null || !newStr.equals(oldStr))
			{
				...
				if(!newStr.doFolding())
				{
					...
					JOptionPane.showMessageDialog(this, MessageFormat.format(
						jEdit.getProperty(
							"configurablefoldhandler.optionpaneerror"),
						new Object[] { newStr.getErrorMessage(),
							lastModeName }),
						jEdit.getProperty("configurablefoldhandler.errortitle"),
