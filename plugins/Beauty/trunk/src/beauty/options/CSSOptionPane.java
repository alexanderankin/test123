...
public class CSSOptionPane extends AbstractOptionPane {
    ...
    private void installComponents() {
        ...
        JLabel description = new JLabel( "<html><b>CSS Options" );
        
        padCombinators = new JCheckBox("Pad combinators (+, >, ~)");
        padSelectors = new JCheckBox("Pad selectors");
        padAttribs = new JCheckBox("Pad attributes");
        padOperators = new JCheckBox("Pad operators (/ and ,)");
        padPrio = new JCheckBox("Pad important (!)");
        padTerm = new JCheckBox("Pad terms");
        padParams = new JCheckBox("Pad function parameters");
