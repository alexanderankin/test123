...
public class PropertyParser implements PropertyParserConstants {
  ...
  final public List<Property> Properties() throws ParseException {List<Property> list = new ArrayList<Property>();
    Property p = null;
    try {
      label_1:
      while (true) {
 ...
 */
  final public Property Property() throws ParseException {Token key = null;
    Token value = null;
    try {
      if (jj_2_2(2)) {
