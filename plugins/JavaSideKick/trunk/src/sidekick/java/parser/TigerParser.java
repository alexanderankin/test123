...
public class TigerParser implements TigerParserConstants {
   ...
   public void error_skipto(int kind, ParseException pe) {
       if (pe == null) {
  ...
  final public List<TigerNode> MarkerAnnotation() throws ParseException {
    ...
    try {
      ...
      nn = Name();
        ...
        error_skipto(SEMICOLON, pe);    // TODO is there a better token to skip to?   
