...
public class RESearchMatcher extends SearchMatcher
{
	 ...
	 */
	public String[] getSubexpressions(String text) {
		String[] matchedSubexpressions=null;
		...
		//Log.log(Log.DEBUG, BeanShell.class,"tp156: count = "+count);
		if (count > 0) matchedSubexpressions = new String[count+1];
		for(int j = 0; j <= count; j++) {
			matchedSubexpressions[j] = match.toString(j);
			//Log.log(Log.DEBUG, BeanShell.class,"tp156: match.toString(j) = "+match.toString(j));
		}
		return matchedSubexpressions;
	} //}}}
