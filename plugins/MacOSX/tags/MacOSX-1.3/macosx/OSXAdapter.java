...
public class OSXAdapter implements InvocationHandler
{
	...
	public static void setAboutHandler(Object target, Method aboutHandler) {
		...
		try {
			...
			Log.log(Log.ERROR, OSXAdapter.class, "OSXAdapter could not access the About Menu", ex);
		}
	}
	...
	public static void setHandler(OSXAdapter adapter) {
		try {
			...
			Log.log(Log.ERROR, OSXAdapter.class, "This version of Mac OS X does not support the Apple EAWT." +
				"ApplicationEvent handling has been disabled", cnfe);
		}
		catch (Exception ex) {  // Likely a NoSuchMethodException or an IllegalAccessException loading/invoking eawt.Application methods
			Log.log(Log.ERROR, OSXAdapter.class, "Could not talk to EAWT:", ex);
		}
	}
	...
	protected void setApplicationEventHandled(Object event, boolean handled) {
		if (event != null) {
			try {
				...
				Log.log(Log.ERROR, this, "Unable to handle an ApplicationEvent: " + event, ex);				
			}
		}
	}
}
