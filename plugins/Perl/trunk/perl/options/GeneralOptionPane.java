...
public class GeneralOptionPane extends AbstractOptionPane {
	...
	static final String PERL_PATH_LABEL = PREFIX + "perl_path_label";
	static public final String PERL_PATH_PROP = PREFIX + "perl_path";
	...
	public GeneralOptionPane() {
		...
		pathTF = new JTextField(40);
		addComponent(jEdit.getProperty(PERL_PATH_LABEL), pathTF);
		pathTF.setText(jEdit.getProperty(PERL_PATH_PROP));
	...
	public void _save()
	{
		jEdit.setProperty(PERL_PATH_PROP, pathTF.getText());
