...
* ====================================================================
*
* danson, modified for jEdit, mostly just took out the System.exit()'s
*/
 ...
 */
public class SVN2 extends org.tmatesoft.svn.cli.SVN {
            ...
            if ( command != null ) {
                ...
                try {
                    ...
                    */
                    ...
                    SVNClientManager clientManager = ( SVNClientManager ) PrivilegedAccessor.invokeMethod( command, "getClientManager", null );
                ...
                */
                ...
                return "Error: unknown command name '" + commandName + "'";
                /*
