...
public class DockerPlugin extends EBPlugin
{
	...
	public DockerPlugin()
	{
		handlers = new HashMap<View, ViewHandler>(2);
	...
	public void handleMessage(EBMessage message)
	{
		...
		{
			for (Iterator<ViewHandler> i = handlers.values().iterator(); i.hasNext();)
			{
				i.next().init();
			}
		}
	...
	{
		showDockPopup(view, view.getDockableWindowManager().getLeftDockingArea(),
	...
	{
		showDockPopup(view, view.getDockableWindowManager().getBottomDockingArea(),
	...
	{
		showDockPopup(view, view.getDockableWindowManager().getRightDockingArea(),
