...
// }}} imports
public class AddRunSettingDialog extends EnhancedDialog implements ActionListener {
	private View view;
	...
	public AddRunSettingDialog(View view, VPTProject proj) {
		super(view, "Add Run Setting", true);
		this.view = view;
		this.proj = proj;
