...
public class BufferLocalPlugin extends EBPlugin {
     ...
     * there are 2 properties, "bufferlocal.staleTime", which is the number of minutes
     * that a file can remain open without being used before it will be closed, and
     * "bufferlocal.removeStale" which is a boolean to decide if stale files should
     * be closed after the staleTime has been reached. 
     */
    ...
    /**
     * Gets a list of the currently open buffers and populated openBuffers.    
     */
    ...
    // runs at a low priority to close stale buffers
