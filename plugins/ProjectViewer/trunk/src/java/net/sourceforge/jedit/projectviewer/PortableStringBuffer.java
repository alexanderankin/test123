/*
This is a PortableStringBuffer from GNU Classpath that is portable across JDK 
versions.  It is based on a GPL java.lang.StringBuffer and the only changes
is that the package is buildtools and the class is PortableStringBuffer instead
of StringBuffer
 ...
 */
public final class PortableStringBuffer implements java.io.Serializable {
   ...
   */
  public PortableStringBuffer(int len) throws NegativeArraySizeException {
    str = new char[len];
  }
...

   ...
   */
  public PortableStringBuffer append(char[] str) 
   ...
   *  @XXX do a more direct append in the future.
   */
  public PortableStringBuffer append(char[] str, int offset, int len)
       throws NullPointerException, IndexOutOfBoundsException {
   ...
   *  @XXX do a more direct append in the future.
   */
  public PortableStringBuffer append(char c) {
...

   ...
   *  @see java.lang.String#valueOf(java.lang.Object)
   */
  public PortableStringBuffer insert(int offset, Object obj) 
    throws IndexOutOfBoundsException {
   ...
   */
  public PortableStringBuffer insert(int offset, char[] str)
    throws NullPointerException, IndexOutOfBoundsException {
   ...
   *  @XXX insert more directly in the future.
   */
  public PortableStringBuffer insert(int offset, char[] str, int str_offset, int len)
    throws NullPointerException, IndexOutOfBoundsException {
   ...
   *  @XXX insert more directly in the future.
   */
  public PortableStringBuffer insert(int offset, char c) 
    throws IndexOutOfBoundsException {
...
// JDK 1.2 additions
   ...
   *             is out of bounds.
   */
  public PortableStringBuffer deleteCharAt(int index)
    throws StringIndexOutOfBoundsException {
    if (index < 0 || index >= len)
      throw new StringIndexOutOfBoundsException(index);
