...
/**
 * A general configuration dialog.
 */
public class ConfigDialog extends EnhancedDialog implements ActionListener
{
   ...
   /**
    * Create a new <code>ConfigDialog</code>.
    */
   public ConfigDialog(Frame owner, String title, Component aConfigComponent)
   {
