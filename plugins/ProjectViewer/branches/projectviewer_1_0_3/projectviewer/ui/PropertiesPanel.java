         ...
         implements MouseListener, ActionListener
{
   ...
   public final static String ADD_PROPERTY_CMD = "addProperty";
   public final static String REMOVE_PROPERTY_CMD = "removeProperty";
   ...
   public static void showDialog(View view, Project prj)
   {
      ...
      ConfigDialog dialog =
         new ConfigDialog(view, "Properties for " + prj.getName(), propsPanel) {
            public void ok() {
   ...
   public void addProperty()
   {
      ...
      if (props.getProperty(propName) != null) {
         boolean result = UI.confirmYesNo(this, "overwrite-property",
                                          new String[] {propName});
         if (!result)
            return ;
      }
   ...
   public final void mousePressed(MouseEvent evt)
   {
      ...
      if (table.getSelectedRow() != -1)
         popup.add(createMenuItem("Remove", REMOVE_PROPERTY_CMD));
