...
//{{{ Expression()
  ...
  Expression expr;
    ...
    {if (true) return new PrefixedUnaryExpression(expr,OperatorIds.NOT,bangToken.sourceStart,bangToken.beginLine,bangToken.beginColumn);}
    throw new Error("Missing return statement in function");
  }
