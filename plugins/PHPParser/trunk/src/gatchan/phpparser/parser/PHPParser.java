 ...
 */
  ...
  final private boolean jj_3R_203() {
    ...
    if (jj_scan_token(NAMESPACE_NAME)) return true;
    if (jj_scan_token(SEMICOLON)) return true;
    return false;
  }
