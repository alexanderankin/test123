 ...
 * or <? somephpcode ?>
 */
  final public void phpBlock() throws ParseException {PHPEchoBlock phpEchoBlock;
        Token token;
        Token phpEnd;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case PHPECHOSTART:{
...
//{{{ phpEchoBlock() method
  final public PHPEchoBlock phpEchoBlock() throws ParseException {Expression expr;
...
//{{{ namespace() method
  final public Namespace namespace() throws ParseException {Token namespaceToken;
...
String namespaceName = namespaceNameToken == null ? null : namespaceNameToken.image;
                        ...
                        {if ("" != null) return new Namespace(namespace,
...
//{{{ useNamespace() method
  final public UseNamespace useNamespace() throws ParseException {Token useToken;
...
{if ("" != null) return new UseNamespace(list,
...
//{{{ interfaceDeclaration()
  final public InterfaceDeclaration interfaceDeclaration() throws ParseException {Token modifierToken;
...
currentSegment = interfaceDeclaration.getParent();
                ...
                {if ("" != null) return interfaceDeclaration;}
    throw new Error("Missing return statement in function");
  }
...
//{{{ classConstant() method
  final public List<ClassConstant> classConstant() throws ParseException {Token constToken, token;
...
//{{{ _classConstant() method
  final public ClassConstant _classConstant(Token startToken) throws ParseException {Token identifier;
        Token token;
        String constName = SYNTAX_ERROR_CHAR;
...
{if ("" != null) return new ClassConstant(namespace,
                        path,
                        currentSegment,
                        constName,
                        initializer,
 ...
 */
  final public MethodDeclaration interfaceMethodDeclaration(List<Modifier> modifiers) throws ParseException {MethodDeclaration functionDeclaration;
...
{if ("" != null) return functionDeclaration;}
    throw new Error("Missing return statement in function");
  }

//}}}

//{{{ traitDeclaration() method
/**
 * A trait declaration.
 * trait <IDENTIFIER> trait body
 *
 * @return a TraitDeclaration
 */
  final public TraitDeclaration traitDeclaration() throws ParseException {TraitHeader header;
        TraitDeclaration declaration;
    header = traitHeader();
declaration = new TraitDeclaration(currentSegment,
                        header,
                        header.getSourceStart(),
                        header.getSourceEnd(),
                        header.getBeginLine(),
                        header.getEndLine(),
                        header.getBeginColumn(),
                        header.getEndColumn());
                currentSegment.add(declaration);
                currentSegment = declaration;
                scope = new Scope();
                scopeStack.push(scope);
    traitBody(declaration);
currentSegment = currentSegment.getParent();
                scope = scopeStack.pop();
                pushOnAstNodes(declaration);
...
//{{{ traitHeader() method
  final public TraitHeader traitHeader() throws ParseException {Token traitToken;
        Token traitName = null;
    traitToken = jj_consume_token(TRAIT);
    try {
      traitName = jj_consume_token(IDENTIFIER);
    } catch (ParseException e) {
fireParseError("identifier expected","identifier",e.currentToken.next);
    }
{if ("" != null) return new TraitHeader(namespace, path, traitToken, new ObjectIdentifier(traitName));}
    throw new Error("Missing return statement in function");
  }
...
//{{{ traitBody() method
  final public void traitBody(TraitDeclaration declaration) throws ParseException {Token lBraceToken;
        Token rBraceToken;
        MethodDeclaration method;
    try {
      lBraceToken = jj_consume_token(LBRACE);
declaration.setBodyLineStart(lBraceToken.beginLine);
                        declaration.setBodyColumnStart(lBraceToken.beginColumn);
    } catch (ParseException e) {
fireParseError("'{' expected", "{", e.currentToken);
    ...
    while (true) {
      ...
      method = methodDeclaration(CONST_METHOD, Collections.emptyList());
declaration.addMethod(method);
    }
    try {
      rBraceToken = jj_consume_token(RBRACE);
declaration.setBodyLineEnd(rBraceToken.endLine);
                        declaration.setBodyColumnEnd(rBraceToken.endColumn);
    } catch (ParseException e) {
fireParseError("'}' expected", "}", e.currentToken.next);
 ...
 */
  final public ClassDeclaration classDeclaration() throws ParseException {ClassHeader classHeader;
...
//{{{ classHeader(Token abstractToken)
  final public ClassHeader classHeader(Token abstractToken) throws ParseException {Token classToken;
...
int end,endLine,endColumn;
                ...
                {if ("" != null) return new ClassHeader(namespace,
                                       path,
...
//{{{ classBody(ClassDeclaration classDeclaration)
  final public void classBody(ClassDeclaration classDeclaration) throws ParseException {Token lBraceToken;
        Token rBraceToken;
    try {
      lBraceToken = jj_consume_token(LBRACE);
...
//{{{ abstractClassBody(ClassDeclaration classDeclaration)
  final public void abstractClassBody(ClassDeclaration classDeclaration) throws ParseException {Token lBraceToken;
  Token rBraceToken;
    try {
      lBraceToken = jj_consume_token(LBRACE);
classDeclaration.setBodyLineStart(lBraceToken.beginLine);
...
//{{{ classBodyDeclaration() method
/**
 * A class can contain only methods and fields.
 */
  final public void classBodyDeclaration(ClassDeclaration classDeclaration) throws ParseException {MethodDeclaration method;
...
for (ClassConstant classConstant:classConstants)
    ...
    case USE:{
      useToken = jj_consume_token(USE);
      try {
        traitIdentifier = jj_consume_token(IDENTIFIER);
      } catch (ParseException e) {
fireParseError("identifier expected","identifier",e.currentToken.next);
 ...
 * A class can contain only methods and fields.
 */
  final public Modifier commonModifiers() throws ParseException {Token token;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case STATIC:{
...
{if ("" != null) return new Modifier(token);}
    throw new Error("Missing return statement in function");
  }
...
//{{{ methodModifiers()
  final public Modifier methodModifiers() throws ParseException {Token token;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case FINAL:{
 ...
 * A class can contain only methods and fields.
 */
  final public void abstractClassBodyDeclaration(ClassDeclaration classDeclaration) throws ParseException {MethodDeclaration method;
        List<FieldDeclaration> fieldList;
        Modifier modifier;
        List<Modifier> modifiers = new ArrayList<Modifier>();
        List<FieldDeclaration> fields;
 ...
 */
  final public List<FieldDeclaration> fieldDeclaration() throws ParseException {List<FieldDeclaration> arrayList;
 ...
 * it is only used by ClassBodyDeclaration()
 */
  final public List<FieldDeclaration> fieldDeclarationPHP5(List<Modifier> modifiers) throws ParseException {VariableDeclaration variableDeclaration;
 ...
 */
  final public VariableDeclaration field() throws ParseException {Token identifierToken, lbrace,rbrace;
        Expression expr;
        Expression initializer = null;
...
setTypeFromScope(variable);
                if (assignToken == null)
                {
                        {if ("" != null) return new VariableDeclaration(currentSegment, variable);}
                }
                if (initializer == null)
                {
                        {if ("" != null) return new VariableDeclaration(currentSegment,
                                variable,
                                null,
                                "=",
 ...
 */
  final public VariableDeclaration VariableDeclaratorNoSuffix() throws ParseException {Token identifierToken, lbrace,rbrace;
        Expression expr;
        Expression initializer = null;
        Token assignToken = null;
        Token dollarToken;
 ...
 */
  final public VariableDeclaration VariableDeclarator() throws ParseException {AbstractVariable variable;
        Expression initializer = null;
        Token assignToken = null;
 ...
 */
  final public AbstractVariable VariableDeclaratorId() throws ParseException {AbstractVariable var;
    var = Variable();
    label_20:
    while (true) {
      if (jj_2_1(2)) {
...
//{{{ Variable()
  final public Variable Variable() throws ParseException {Variable variable;
        Token dollarToken;
    dollarToken = jj_consume_token(DOLLAR);
    try {
      variable = Var();
...
//{{{ Var()
  final public Variable Var() throws ParseException {Variable variable;
        Token token, token2;
...
//{{{ VariableInitializer()
  final public  Expression VariableInitializer() throws ParseException {Expression expr;
    if (jj_2_2(2)) {
      expr = Literal();
{if ("" != null) return expr;}
    } else {
...
{if ("" != null) return new PrefixedUnaryExpression(new NumberLiteral(Type.INTEGER,value),
                                       operator);}
        break;
        }
      case ARRAY:
...
//{{{ arrayVariable() method
  final public ArrayVariableDeclaration arrayVariable() throws ParseException {Expression expr;
        Expression expr2;
...
int sourceEnd,endLine,endColumn;
                        ...
                        {if ("" != null) return new ArrayVariableDeclaration(expr,expr2,expr.getSourceStart(),sourceEnd,expr.getBeginLine(),endLine,expr.getBeginColumn(),endColumn);}
      break;
      }
    default:
      jj_la1[57] = jj_gen;
...
{if ("" != null) return new ArrayVariableDeclaration(expr,expr.getSourceEnd(),expr.getBeginLine(),expr.getEndLine(),expr.getBeginColumn(),expr.getEndColumn());}
    throw new Error("Missing return statement in function");
  }

//}}}

//{{{ arrayInitializer() method
  final public ArrayVariableDeclaration[] arrayInitializer() throws ParseException {ArrayVariableDeclaration expr;
 ...
 * @return a MethodDeclaration
 */
  final public MethodDeclaration methodDeclaration(int type, List<Modifier> modifiers) throws ParseException {MethodDeclaration functionDeclaration;
        MethodHeader methodHeader;
        Block block;
...
//{{{ closureDeclaration()
  final public MethodDeclaration closureDeclaration() throws ParseException {MethodDeclaration functionDeclaration;
 ...
 */
  final public MethodHeader methodHeader(Token functionToken,int type, List<Modifier> modifiers) throws ParseException {Token reference = null;
        List<FormalParameter> formalParameters = new ArrayList<FormalParameter>();
...
try
    ...
    formalParameters(formalParameters);
{if ("" != null) return new MethodHeader(namespace,
                                        path,
                                        modifiers,
                                        identifierChar,
                                        reference != null,
 ...
 */
  final public Token functionIdentifier() throws ParseException {Token functionIdentifier;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IDENTIFIER:{
...
{if ("" != null) return functionIdentifier;}
    throw new Error("Missing return statement in function");
  }
 ...
 * @return an identifier for a function
 */
  final public Token methodIdentifier() throws ParseException {Token methodIdentifier;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IDENTIFIER:{
...
{if ("" != null) return methodIdentifier;}
    throw new Error("Missing return statement in function");
  }
 ...
 * @return an identifier for a function
 */
  final public Token constantIdentifier() throws ParseException {Token constantIdentifier;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NAMESPACE_IDENTIFIER:{
...
{if ("" != null) return constantIdentifier;}
    throw new Error("Missing return statement in function");
  }

//}}}

//{{{ constantIdentifierExpression() method
  final public Expression constantIdentifierExpression() throws ParseException {Token constantIdentifier;
    constantIdentifier = constantIdentifier();
{if ("" != null) return new ConstantIdentifier(constantIdentifier);}
    throw new Error("Missing return statement in function");
  }
 ...
 * (formalParameter())
 */
  final public void formalParameters(List<FormalParameter> parameters) throws ParseException {FormalParameter var;
    try {
      jj_consume_token(LPAREN);
    } catch (ParseException e) {
fireParseError("'(' expected", "(",e.currentToken);
 ...
 */
  final public FormalParameter formalParameter() throws ParseException {VariableDeclaration variableDeclaration;
...
//{{{ Type()
  final public ConstantIdentifier Type() throws ParseException {Token token;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case STRING:{
...
{if ("" != null) return new ConstantIdentifier(token);}
    throw new Error("Missing return statement in function");
  }
...
//{{{ Parse Exception
                        fireParseError(new PHPParseErrorEvent(ERROR,
                                ...
                                e.currentToken.endColumn,
                                e.currentToken.endColumn)); //}}}
                        {if ("" != null) return new DummyExpression(e.currentToken);}
      }
      break;
      }
    default:
...
//{{{ assignment()
  final public Expression assignment() throws ParseException {Expression expr;
...
//{{{ prefixedPrimaryExpression()
  final public  Expression prefixedPrimaryExpression() throws ParseException {Expression expr;
        Token prefix = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case BANG:{
 ...
 */
  final public Token AssignmentOperator() throws ParseException {Token assignOperator;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case ASSIGN:{
...
//{{{ ConditionalExpression()
  final public Expression ConditionalExpression() throws ParseException {Expression expr;
...
if (expr3 == null)
                ...
                {if ("" != null) return conditionalExpression;}
    throw new Error("Missing return statement in function");
  }
...
//{{{ ConditionalOrExpression()
  final public Expression ConditionalOrExpression() throws ParseException {Expression expr,expr2;
        int sourceEnd,endLine,endColumn;
        Token orToken;
...
//{{{ ConditionalAndExpression()
  final public Expression ConditionalAndExpression() throws ParseException {Expression expr,expr2;
        int sourceEnd,endLine,endColumn;
        Token andToken;
...
//{{{ ConcatExpression()
  final public Expression ConcatExpression() throws ParseException {Expression expr,expr2;
        Token dotToken;
        int sourceEnd,endLine,endColumn;
    expr = assignment();
    label_26:
...
//{{{ InclusiveOrExpression()
  final public Expression InclusiveOrExpression() throws ParseException {Expression expr,expr2;
        Token bitOrToken;
        int sourceEnd,endLine,endColumn;
...
//{{{ ExclusiveOrExpression()
  final public Expression ExclusiveOrExpression() throws ParseException {Expression expr,expr2;
        Token bitXorToken;
        int sourceEnd,endLine,endColumn;
    expr = AndExpression();
    label_28:
...
//{{{ AndExpression()
  final public Expression AndExpression() throws ParseException {Expression expr,expr2;
        Token bitAndToken;
        int sourceEnd,endLine,endColumn;
...
//{{{ instanceofExpression()
  final public Expression instanceofExpression() throws ParseException {Expression expr;
        Expression expr2 = null;
        int sourceEnd,endLine,endColumn;
...
//{{{ RelationalExpression()
  final public Expression RelationalExpression() throws ParseException {Expression expr,expr2;
        int sourceEnd,endLine,endColumn;
        Token token;
...
//{{{ ShiftExpression()
  final public Expression ShiftExpression() throws ParseException {Expression expr,expr2;
        int sourceEnd,endLine,endColumn;
        Token shiftToken;
...
//{{{ AdditiveExpression()
  final public Expression AdditiveExpression() throws ParseException {Expression expr,expr2;
        int sourceEnd,endLine,endColumn;
        Token token;
...
//{{{ AtNotTildeUnaryExpression()
  final public Expression AtNotTildeUnaryExpression() throws ParseException {if (shouldStop)
 ...
 */
  final public Expression AtNotUnaryExpression() throws ParseException {Expression expr;
        Token prefix = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case AT:{
      prefix = jj_consume_token(AT);
...
//{{{ UnaryExpressionNoPrefix()
  final public Expression UnaryExpressionNoPrefix() throws ParseException {Expression expr;
        Token prefix = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case PLUS:{
...
//{{{ PreIncDecExpression()
  final public Expression PreIncDecExpression() throws ParseException {Expression expr;
        Token prefix;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case PLUS_PLUS:{
    ...
    expr = primaryExpression();
{if ("" != null) return new PrefixedUnaryExpression(expr, prefix);}
    throw new Error("Missing return statement in function");
  }
...
//{{{ UnaryExpressionNotPlusMinus()
  final public Expression UnaryExpressionNotPlusMinus() throws ParseException {Expression expr;
...
//{{{ CastExpression()
  final public CastExpression CastExpression() throws ParseException {ConstantIdentifier type;
        Expression expr;
        Token lParen;
        Token arrayToken;
...
type = new ConstantIdentifier(arrayToken);
    ...
    jj_consume_token(RPAREN);
    expr = unaryExpression();
{if ("" != null) return new CastExpression(type,
                        expr,
                        lParen.sourceStart,
                        expr.getSourceEnd(),
                        lParen.beginLine,
...
//{{{ PostfixExpression()
  final public Expression PostfixExpression() throws ParseException {Expression expr;
        Token token = null;
    expr = primaryExpression();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case PLUS_PLUS:
...
if (token == null)
                ...
                {if ("" != null) return new PostfixedUnaryExpression(expr,
                        token.kind,
                        token.sourceEnd,
                        token.endLine,
                        token.endColumn);}
...
//{{{ primaryExpression()
  final public Expression primaryExpression() throws ParseException {Expression expr;
        Token bitAndToken = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case STATIC:
    case NEW:
...
//{{{ refPrimaryExpression()
/**
 * @param bitAndToken it is the token with the &, it can be null if there is no
 * such token
 */
  final public Expression refPrimaryExpression(Token bitAndToken) throws ParseException {Expression expr;
    expr = prefix(bitAndToken);
    label_35:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case CLASSACCESS:
 ...
 * such token
 */
  final public Expression prefix(Token bitAndToken) throws ParseException {Expression expr;
        Token identifier;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NEW:{
    ...
    case IDENTIFIER:
    case NAMESPACE_IDENTIFIER:{
      expr = constantIdentifierExpression();
      break;
      }
    case STATIC:{
...
//{{{ suffix() method
  final public Expression suffix(Expression expr) throws ParseException {ArgumentList argumentList;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LPAREN:{
...
expr = new FunctionCall(expr, argumentList);
    ...
    case LBRACKET:
    case LBRACE:{
      expr = arrayDeclaratorSuffix(expr);
      break;
      }
    default:
      jj_la1[111] = jj_gen;
...
//{{{ fullyQualifiedIdentifier() method
  final public Expression fullyQualifiedIdentifier() throws ParseException {Token token;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NAMESPACE_IDENTIFIER:{
...
//{{{ superClassOrInterface() method
  final public Token superClassOrInterface() throws ParseException {Token token;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NAMESPACE_IDENTIFIER:{
      token = jj_consume_token(NAMESPACE_IDENTIFIER);
      break;
...
//{{{ namespaceIdentifier() method
  final public Token namespaceIdentifier() throws ParseException {Token token;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NAMESPACE_IDENTIFIER:{
      token = jj_consume_token(NAMESPACE_IDENTIFIER);
      break;
...
//{{{ instantiation()
  final public Expression instantiation(Token reference) throws ParseException {Token newToken;
        Expression expr;
...
int start, beginLine, beginColumn;
                Token beginToken = reference == null ? newToken:reference;
                start       = beginToken.sourceStart;
                beginLine   = beginToken.beginLine;
                beginColumn = beginToken.beginColumn;
...
//{{{ cloning()
  final public Expression cloning() throws ParseException {AbstractVariable variable;
...
//{{{ arrayDeclarator() method
/**
 * An array declarator.
 * array(vars)
 * @return an array
 */
  final public ArrayInitializer arrayDeclarator() throws ParseException {ArrayVariableDeclaration[] vars;
        Token arrayToken;
        Token lbracketToken;
        Token rbracketToken;
        ArrayVariableDeclaration expr;
        List<ArrayVariableDeclaration> varList = new ArrayList<ArrayVariableDeclaration>();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case ARRAY:{
      //{{{ array()
                      arrayToken = jj_consume_token(ARRAY);
      vars = arrayInitializer();
{if ("" != null) return new ArrayInitializer(vars,
...
{if ("" != null) return new ArrayInitializer(varList.toArray(new ArrayVariableDeclaration[varList.size()]),
                                lbracketToken.sourceStart,
                                rbracketToken.sourceEnd,
                                lbracketToken.beginLine,
                                rbracketToken.endLine,
                                lbracketToken.beginColumn,
                                rbracketToken.endColumn);}
      break;
      }
    default:
      jj_la1[119] = jj_gen;
 ...
 */
  final public ClassIdentifier classIdentifier() throws ParseException {Token identifierToken;
    identifierToken = methodIdentifier();
{if ("" != null) return new ClassIdentifier(identifierToken);}
    throw new Error("Missing return statement in function");
  }
 ...
 */
  final public AbstractVariable VariableSuffix(Expression prefix) throws ParseException {AbstractVariable abstractVariable;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case CLASSACCESS:{
    ...
    case LBRACKET:
    case LBRACE:{
      abstractVariable = arrayDeclaratorSuffix(prefix);
      break;
      }
    default:
      jj_la1[120] = jj_gen;
...
{if ("" != null) return abstractVariable;}
    throw new Error("Missing return statement in function");
  }
 ...
 */
  final public ClassAccess staticClassAccess(Expression expr) throws ParseException {Expression expr2;
        ClassAccess ca;
...
//{{{ classAccess() method
  final public ClassAccess classAccess(Expression prefix) throws ParseException {Token lbrace, rbrace, token;
        Token classAccess;
        Expression expression;
...
expression = new Variable(expression,
      ...
      case INTERFACE:{
Token interfaceIdentifier;
        interfaceIdentifier = jj_consume_token(INTERFACE);
expression =  new ConstantIdentifier(interfaceIdentifier);
        break;
        }
      case CLASS:
      case FUNCTION:
...
{if ("" != null) return new ClassAccess(prefix,
                                       expression,
                                       CLASSACCESS,
...
//{{{ arrayDeclaratorSuffix(Expression prefix) method
  final public ArrayDeclarator arrayDeclaratorSuffix(Expression prefix) throws ParseException {Token open;
        Token close = null;
...
if (close == null)
                ...
                {if ("" != null) return new ArrayDeclarator(prefix,
                                           expression,
                                           sourceEnd,
                                           endLine,
                                           endColumn);}
...
//{{{ Literal()
  final public Literal Literal() throws ParseException {Token token;
        StringLiteral stringLiteral;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case INTEGER_LITERAL:{
      token = jj_consume_token(INTEGER_LITERAL);
{if ("" != null) return new NumberLiteral(Type.INTEGER,token);}
      break;
      }
    case FLOATING_POINT_LITERAL:{
...
{if ("" != null) return new StringLiteral(token);}
      break;
      }
    case TRUE:{
      token = jj_consume_token(TRUE);
{if ("" != null) return new TrueLiteral(token);}
      break;
      }
    case FALSE:{
      token = jj_consume_token(FALSE);
{if ("" != null) return new FalseLiteral(token);}
      break;
      }
    case NULL:{
      token = jj_consume_token(NULL);
{if ("" != null) return new NullLiteral(token);}
      break;
      }
    case HEREDOCSTARTTOKEN:{
...
//{{{ heredoc()
  final public StringLiteral heredoc() throws ParseException {Token heredocStart;
        Token startToken;
        Token endToken;
        String endImage;
...
if(heredocStart.sourceEnd != startToken.sourceStart)
                        ...
                        {if ("" != null) return new StringLiteral("",
...
//{{{ evaluableString()
  final public StringLiteral evaluableString() throws ParseException {List<Expression> list = new ArrayList<Expression>();
        Token start,end;
        Expression expr;
        Token identifier;
...
//{{{ arguments()
  final public ArgumentList arguments() throws ParseException {Expression[] args = null;
        Token rparen,lparen;
    lparen = jj_consume_token(LPAREN);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case FUNCTION:
...
{if ("" != null) return new ArgumentList(args,
                                lparen.sourceStart,
                                rparen.sourceEnd,
                                lparen.beginLine,
                                rparen.endLine,
 ...
 */
  final public Expression[] ArgumentList() throws ParseException {Expression arg;
        List<Expression> list = new ArrayList<Expression>();
    arg = _argument();
list.add(arg);
    label_38:
...
//{{{ _argument() method
  final public Expression _argument() throws ParseException {Expression arg;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case ARRAY:
    case LIST:
    case PRINT:
 ...
 * @return a statement
 */
  final public Statement StatementNoBreak() throws ParseException {Statement statement;
    if (jj_2_8(2)) {
...
//{{{ throwStatement()
  final public ThrowStatement throwStatement() throws ParseException {Token throwToken;
        Expression expr;
...
{if ("" != null) return new ThrowStatement(expr,
...
//{{{ tryStatement()
  final public TryStatement tryStatement() throws ParseException {Token tryToken;
        Block block;
        Catch catchClause;
...
{if ("" != null) return new TryStatement(block,
                        catches,
...
//{{{ catchClause()
  final public Catch catchClause() throws ParseException {Token catchToken;
...
fireParseError("')' expected", ")", e.currentToken);
    ...
    block = Block();
{if ("" != null) return new Catch(catchedString,
 ...
 */
  final public Statement expressionStatement() throws ParseException {Statement statement;
        Token token;
    try {
...
token = error_skipto(SEMICOLON);
                fireParseError(new PHPParseErrorEvent(ERROR,
                        ...
                        e.currentToken.endColumn,
                        token.beginColumn));
                {if ("" != null) return new EmptyStatement(e.currentToken.sourceStart,
                        token.sourceEnd,
                        e.currentToken.beginLine,
                        token.endLine,
                        e.currentToken.beginColumn,
...
//{{{ constantStatement()
  final public List<Const> constantStatement() throws ParseException {Token constToken;
        Token identifierToken;
...
//{{{ _const()
  final public Const _const() throws ParseException {Token identifierToken;
        Expression identifier;
        Expression value = null;
    try {
      identifierToken = jj_consume_token(IDENTIFIER);
...
{if ("" != null) return new Const(currentSegment,
                                  identifier,
                                  value,
...
//{{{ defineStatement()
  final public Define defineStatement() throws ParseException {Expression defineName;
...
{if ("" != null) return new Define(currentSegment,
                                  defineName,
                                  defineValue,
 ...
 * A Normal statement.
 */
  final public Statement Statement() throws ParseException {Statement statement;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case TRY:
    case THROW:
    case IF:
 ...
 */
  final public HTMLBlock htmlBlock() throws ParseException {int startIndex = nodePtr;
        AstNode[] blockNodes;
        int nbNodes;
        Token phpEnd;
    phpEnd = jj_consume_token(PHPEND);
 ...
 */
  final public InclusionExpression IncludeExpression() throws ParseException {Expression expr;
...
inclusionExpression = new InclusionExpression(currentSegment,
                ...
                {if ("" != null) return inclusionExpression;}
    throw new Error("Missing return statement in function");
  }
...
//{{{ PrintExpression()
  final public PrintExpression PrintExpression() throws ParseException {Expression expr;
        Token printToken;
    printToken = jj_consume_token(PRINT);
    expr = expression();
{if ("" != null) return new PrintExpression(expr,printToken.sourceStart,
...
//{{{ listExpression() method
  final public ListExpression listExpression() throws ParseException {AbstractVariable expr = null;
...
AbstractVariable[] vars = new AbstractVariable[list.size()];
                list.toArray(vars);
                {if ("" != null) return new ListExpression(vars,
 ...
 */
  final public EchoStatement EchoStatement() throws ParseException {List<Expression> expressions = new ArrayList<Expression>();
        Expression expr;
        Token echoToken;
...
Expression[] exprs = new Expression[expressions.size()];
                ...
                if (semicolonToken == null)
                {
                        ...
                        {if ("" != null) return new EchoStatement(exprs,
...
//{{{ GlobalStatement()
  final public GlobalStatement GlobalStatement() throws ParseException {Variable expr;
...
//{{{ StaticStatement()
  final public StaticStatement StaticStatement() throws ParseException {List<VariableDeclaration> vars = new ArrayList<VariableDeclaration>();
...
VariableDeclaration[] variables = new VariableDeclaration[vars.size()];
                vars.toArray(variables);
                {if ("" != null) return new StaticStatement(variables,
                        token.sourceStart,
                        pos,
                        token.beginLine,
                        line,
...
//{{{ labelIdentifier()
  final public ConstantIdentifier labelIdentifier() throws ParseException {Token label;
    label = jj_consume_token(IDENTIFIER);
{if ("" != null) return new ConstantIdentifier(label);}
    throw new Error("Missing return statement in function");
  }
...
//{{{ gotoStatement() method
  final public GotoStatement gotoStatement() throws ParseException {Token gotoToken;
...
fireParseError("label expected", "label",e.currentToken.next);
                semicolon = error_skipto(SEMICOLON);
                {
                        if (semicolon.kind == SEMICOLON)
                        {
                                ...
                                line = gotoToken.endLine;
                                column = gotoToken.endColumn;
                                {if ("" != null) return new GotoStatement(gotoToken, label, pos,line,column);}
                        }
                }
    }
    try {
...
//{{{ labeledStatement() method
  final public LabeledStatement labeledStatement() throws ParseException {ConstantIdentifier label;
        Statement statement = null;
    label = labelIdentifier();
    try {
Token colonToken;
      colonToken = jj_consume_token(COLON);
{if ("" != null) return new LabeledStatement(label, colonToken.sourceEnd,
                                colonToken.endLine, colonToken.endColumn);}
    } catch (ParseException e) {
fireParseError("':' expected", ":",e.currentToken);
                {
                        {if ("" != null) return new LabeledStatement(label,
                                e.currentToken.sourceEnd,
                                e.currentToken.endLine,
                                e.currentToken.endColumn);}
                }
 ...
 * @return a block
 */
  final public Block Block() throws ParseException {List<Statement> list = new ArrayList<Statement>();
        Statement statement;
        Token lbrace;
        Token rbrace;
...
Statement[] statements = new Statement[list.size()];
                ...
                {if ("" != null) return new Block(statements,
                                 start,
                                 pos,
                                 beginLine,
                                 endLine,
...
//{{{ BlockStatement() method
  final public Statement BlockStatement() throws ParseException {Statement statement = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case TRY:
    case THROW:
    case IF:
 ...
 */
  final public Statement BlockStatementNoBreak() throws ParseException {Statement statement;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case TRY:
    case THROW:
    case IF:
 ...
 */
  final public Expression[] LocalVariableDeclaration() throws ParseException {List<Expression> list = new ArrayList<Expression>();
        Expression var;
    var = expression();
list.add(var);
    label_47:
 ...
 */
  final public EmptyStatement EmptyStatement() throws ParseException {Token token;
    token = jj_consume_token(SEMICOLON);
/*    fireParseMessage(new PHPParseMessageEvent(INFO,
		path,
		"unneeded ';'",
		...
		token.endColumn,
		token.endColumn+1));   */
                {if ("" != null) return new EmptyStatement(token.sourceStart,
                        token.sourceEnd,
                        token.beginLine,
                        token.endLine,
                        token.beginColumn,
...
//{{{ SWITCH
//{{{ SwitchStatement()
  final public SwitchStatement SwitchStatement() throws ParseException {Expression variable;
        AbstractCase[] cases;
...
{if ("" != null) return new SwitchStatement(variable,
                        cases,
...
//{{{ switchStatementBrace()
  final public AbstractCase[] switchStatementBrace() throws ParseException {AbstractCase cas;
 ...
 */
  final public AbstractCase[] switchStatementColon(int start, int end) throws ParseException {AbstractCase cas;
        List<AbstractCase> cases = new ArrayList<AbstractCase>();
        Token token;
        int pos;
...
//{{{ switchLabel0()
  final public AbstractCase switchLabel0() throws ParseException {Expression expr;
        Statement statement;
...
int listSize = stmts.size();
                ...
                {//it's a default
                        ...
                        {if ("" != null) return new DefaultCase(stmtsArray,
                                start,
                                end,
 ...
 */
  final public Expression SwitchLabel() throws ParseException {Expression expr;
        Token token;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case CASE:{
...
//{{{ BreakStatement() method
  final public Break BreakStatement() throws ParseException {Expression expression = null;
        Token token, token2;
        int pos;
...
{if ("" != null) return new Break(expression, token.sourceStart, pos,
...
//{{{ condition() method
  final public Expression condition(String keyword) throws ParseException {Expression condition;
    try {
      jj_consume_token(LPAREN);
    } catch (ParseException e) {
fireParseError(new PHPParseErrorEvent(ERROR,
...
//{{{ IF
//{{{ ifStatement method
  final public IfStatement ifStatement() throws ParseException {Expression condition;
...
//{{{ statementList()
  final public List<Statement> statementList() throws ParseException {List<Statement> list = new ArrayList<Statement>();
        Statement statement;
    label_51:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
//{{{ ifStatementAction() method
  final public IfStatement ifStatementAction(Expression condition, Token ifToken) throws ParseException {Statement statement;
        Statement stmt;
...
elseIfs = new ElseIf[elseIfList.size()];
                ...
                if (stmts.size() == 1)
                {
                        {if ("" != null) return new IfStatement(condition,
                                stmts.get(0),
                                elseIfs,
                                elseStatement,
                                ifToken.sourceStart,
...
//{{{ elseIfStatementColon() method
  final public ElseIf elseIfStatementColon() throws ParseException {Expression condition;
        List<Statement> list;
        Token elseifToken;
...
int sizeList = list.size();
                ...
                {if ("" != null) return new ElseIf(condition,
                        stmtsArray,
...
//{{{ elseStatementColon()
  final public Else elseStatementColon() throws ParseException {List<Statement> list;
        Token elseToken;
        Token colonToken;
    elseToken = jj_consume_token(ELSE);
    colonToken = jj_consume_token(COLON);
...
int sizeList = list.size();
                ...
                if (sizeList == 0)
                {
                        {if ("" != null) return new Else(stmtsArray,
                                        elseToken.sourceStart,
                                        colonToken.sourceEnd,
                                        elseToken.beginLine,
                                        colonToken.endLine,
...
//{{{ elseIfStatement() method
  final public ElseIf elseIfStatement() throws ParseException {Expression condition;
        Token elseifToken;
...
//{{{ WhileStatement()
  final public 
WhileStatement WhileStatement() throws ParseException {Expression condition;
  Statement action;
  Token whileToken;
    whileToken = jj_consume_token(WHILE);
    condition = condition("while");
    action = WhileStatementAction(whileToken);
{if ("" != null) return new WhileStatement(condition,
                               action,
...
//{{{ WhileStatementAction(Token whileToken)
  final public Statement WhileStatementAction(Token whileToken) throws ParseException {Statement statement;
        List<Statement> stmts;
        Token colonToken;
        int end;
        int endLine;
...
errorMessage = "'endwhile' expected";
      ...
      try {
        semicolonToken = jj_consume_token(SEMICOLON);
                        ...
                        stmts.toArray(stmtsArray);
                        {if ("" != null) return new Block(stmtsArray,
                                whileToken.sourceStart,
                                end,
                                whileToken.beginLine,
                                endLine,
...
//{{{ DoStatement()
  final public DoStatement DoStatement() throws ParseException {Statement action;
...
if (token2 == null) {
      {if ("" != null) return new DoStatement(condition,
                             action,
                             token.sourceStart,
                             condition.getSourceEnd(),
                             token.beginLine,
...
//{{{ ForeachStatement()
  final public ForeachStatement ForeachStatement() throws ParseException {Statement statement = null;
        Expression expression = null;
...
{if ("" != null) return new ForeachStatement(expression,
                                variable,
                                statement,
 ...
 */
  final public ForStatement ForStatement() throws ParseException {Token forToken,tokenEndFor,token2,tokenColon;
        int pos;
...
fireParseError(new PHPParseErrorEvent(ERROR,
    ...
    case LBRACE:{
      action = Statement();
{if ("" != null) return new ForStatement(initializations,
                                condition,
                                increments,
                                action,
...
//{{{ ForInit()
  final public Expression[] ForInit() throws ParseException {Expression[] exprs;
...
//{{{ StatementExpressionList()
  final public Expression[] StatementExpressionList() throws ParseException {List<Expression> list = new ArrayList<Expression>();
        Expression expr;
    expr = expression();
list.add(expr);
    label_54:
...
//{{{ ContinueStatement()
  final public Continue ContinueStatement() throws ParseException {Expression expr = null;
        Token continueToken;
        Token semicolonToken = null;
...
if (semicolonToken == null)
                {
                        if (expr == null)
                        {
                                {if ("" != null) return new Continue(expr,
                        ...
                        {if ("" != null) return new Continue(expr,continueToken.sourceStart,
 ...
 */
  final public ReturnStatement ReturnStatement() throws ParseException {Statement expr = null;
        Token returnToken;
        Token semicolonToken;
        int end       = 0;
        int endLine   = 0;
...
{if ("" != null) return new ReturnStatement(expr,
  ...
  private boolean jj_3R_332()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x6000001e,0x6,0x6,0x6000001e,0x0,0x60000000,0x60000000,0x60000000,0x60000000,0x60000000,0x60000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4000000,0x0,0x4000000,0x4000000,0x4000000,0x4000000,0x0,0x0,0x0,0x20000000,0x0,0x0,0x80000000,0x3c000000,0x3c000000,0x1c000000,0x20000000,0x1c000000,0x20000000,0x3c000000,0x1c000000,0x20000000,0x1c000000,0x20000000,0x1c000000,0x20000000,0x3c000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1c000000,0x5c000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8,0x6,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x60000010,0x60000010,0x60000000,0x20000000,0x0,0x0,0x0,0x0,0x20000010,0x20000010,0x0,0x0,0x0,0x10,0x10,0x0,0x0,0x10,0x0,0x0,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0xd6fff2fb,0x0,0x0,0xd6fff2fb,0x0,0xd6fff2fb,0xd6fff2fb,0xd6fff2bb,0xd6fff2bb,0xd6fff2bb,0xd6fff2bb,0x0,0x0,0x0,0x0,0x0,0x0,0x20000000,0x2800020,0x800000,0x0,0x800000,0x800000,0x2800020,0x0,0x20,0x1,0x11,0x20000000,0x0,0x0,0x28001a1,0x2800121,0x800000,0x1,0x800000,0x21,0x28001a1,0x800000,0x1,0x800000,0x1,0x800000,0x21,0x2800121,0x0,0x88002f30,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x88002f30,0x88003f30,0x0,0x80bd5000,0x0,0x0,0x80,0x0,0x0,0x88002f30,0x0,0x0,0x1000,0x1000,0x1000,0x0,0x0,0x80bd5000,0x80bc5020,0x80bc5000,0x80bc5000,0x0,0x80bd5000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x88002f30,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80bc5000,0x80bc5000,0x80bc5000,0x0,0x80bc5000,0x1000,0x0,0x0,0x0,0x80bc5000,0x0,0x80800000,0x0,0x0,0x0,0x0,0x88002f30,0x0,0x0,0x80bd5000,0x1000,0x0,0x88002f30,0x804001,0x88806f31,0x80bd5000,0x80bd5000,0x0,0x0,0x0,0x0,0x0,0x80bd5020,0x0,0x80bd5020,0x54c2020a,0x4,0x0,0xd4ff720a,0x0,0x0,0x3c0000,0x80bc5000,0x0,0x0,0x0,0x0,0x0,0x0,0xd4fff23b,0xd4fff23b,0xd4fff23b,0xd4ff523b,0x0,0x0,0x9000000,0x9000000,0xd4ff723b,0xd4ff723b,0x0,0x9000000,0x80bd5000,0xd4ff720a,0xd4ff720a,0x400,0x800,0xd4ff720a,0x400,0x800,0xd4ff720a,0xd4ff720a,0xd4ff720a,0x80bd5000,0x80bd5000,0x80bd5000,0xd4ff720a,0x80bd5000,0x0,0x80bd5000,0x80bd5000,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0xffdfc20f,0x0,0x0,0xffdfc20f,0x0,0xffdfc20f,0xffdfc20f,0xffdfc20f,0xffdfc20f,0xffdfc20f,0xffdfc20f,0x0,0x0,0x400,0x0,0x400,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x7fdfc001,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1800,0x7fdfc001,0x7fdfc001,0x2000,0xffdf4001,0x0,0x0,0x0,0x0,0x10000,0x7fdfc001,0x7fc64000,0x0,0x0,0x0,0x0,0x0,0x7fc00000,0xffdf4001,0xffdf4001,0xffdf4001,0xffc64001,0x0,0xffdf4001,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x7fdfc001,0x200000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffdf4001,0xffdf4001,0x7fdf4001,0x0,0x7fdf4001,0x7fc00000,0x0,0x0,0x0,0x7fc64001,0x1800,0x7fc64000,0x1800,0x0,0x0,0x0,0x7fdfc001,0x0,0x0,0xffdf4001,0x0,0x1800,0x7fdfc001,0x0,0x7fdfc001,0xffdf4001,0xffdf4001,0x0,0x190000,0x0,0x0,0x0,0xffdf4001,0x0,0xffdf4001,0xc20e,0x0,0x0,0xffdfc20f,0x0,0x0,0x0,0x7fdf4001,0x0,0x0,0x0,0x0,0x0,0x0,0xffdfc20f,0xffdfc20f,0xffdfc20f,0xffdfc20f,0x0,0x0,0x0,0x0,0xffdfc20f,0xffdfc20f,0x0,0x0,0xffdf4001,0xffdfc20f,0xffdfc20f,0x0,0x0,0xffdfc20f,0x0,0x0,0xffdfc20f,0xffdfc20f,0xffdfc20f,0xffdf4001,0xffdf4001,0xffdf4001,0xffdfc20f,0xffdf4001,0x0,0xffdf4001,0xffdf4001,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x508023c3,0x0,0x0,0x508023c3,0x0,0x508023c3,0x508023c3,0x508023c3,0x508023c3,0x508023c3,0x508023c3,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x300,0x10800000,0x0,0x0,0x300,0x0,0x508023c3,0x0,0x0,0x0,0x2000,0x0,0x0,0x0,0x0,0x2000,0x0,0x0,0x2000,0x0,0x508023c3,0x508023c3,0x508023c3,0x2003,0x0,0x508023cb,0x4,0x300010,0x300010,0x400020,0x400020,0x0,0x4000,0x8000,0x2000,0x0,0x0,0x0,0x0,0x0,0x0,0xe0000,0xe0000,0x300,0x300,0x10c00,0x10c00,0x508023c3,0x508023c1,0x508023c0,0xc0,0x50802000,0x0,0xc0,0xc0,0x2000,0x2000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x508023c3,0x0,0x0,0x0,0x0,0x0,0x508023c3,0x508023c3,0x0,0x50800000,0x0,0x0,0x0,0x508023c3,0x0,0x508023c3,0x0,0x0,0x0,0x508023c3,0x0,0x0,0x0,0x50802000,0x0,0x0,0x0,0x0,0x0,0x0,0x508023c3,0x508023c3,0x508023c3,0x508023c3,0x0,0x8,0x0,0x0,0x508023c3,0x508023c3,0x8,0x0,0x508023c3,0x508023c3,0x508023c3,0x0,0x0,0x508023c3,0x0,0x0,0x508023cb,0x508023cb,0x508023cb,0x508023c3,0x508023c3,0x508023c3,0x508023cb,0x508023c3,0x0,0x508023c3,0x508023c3,};
   }
   private static void jj_la1_init_4() {
      jj_la1_4 = new int[] {0x4a48e2,0x0,0x0,0x4a48e2,0x80000,0x4a48e2,0x4a48e2,0x4a48e2,0x4a48e2,0x4a48e2,0x4a48e2,0x480000,0x400000,0x0,0x100000,0x0,0x100000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x100000,0x0,0x0,0x0,0x0,0x100000,0x0,0x40,0x40,0x0,0x0,0x0,0x40,0x40,0x0,0x0,0x0,0x0,0x0,0x40,0x40,0x100000,0x400080,0x0,0x400080,0x0,0x0,0x4000c0,0x0,0x0,0x420000,0xc0,0x200c0,0x0,0x248e2,0x100000,0x480000,0x0,0x0,0x80,0x80,0x880,0x100000,0x8c0,0x880,0x880,0x0,0x0,0x248e2,0x248e2,0x248e2,0x208c0,0x0,0x248e2,0x0,0x0,0x0,0x0,0x0,0x200000,0x0,0x0,0x0,0xf2000000,0xf2000000,0x8c0,0x0,0xd800000,0xd800000,0x0,0x0,0x0,0x0,0x0,0x0,0x248e2,0x248e2,0x248e2,0x0,0x248e2,0x0,0x0,0x0,0x0,0x208c0,0x424000,0x8c0,0x424000,0x800,0x880,0x880,0x8c0,0x4040,0x100000,0x248e2,0x20000,0x420000,0xc0,0x0,0x4000c0,0x248e2,0x248e2,0x420000,0x22,0x8c,0x8c,0x12,0x248e2,0x100000,0x248e2,0x480000,0x0,0x100000,0x4a48e2,0x0,0x0,0x0,0x248e2,0x40,0x100000,0x40,0x100000,0x100000,0x100000,0x4a48e2,0x4a48e2,0x4a48e2,0x4a48e2,0x100000,0x400000,0x0,0x0,0x4a48e2,0x4a48e2,0x80000,0x0,0x248e2,0x4a48e2,0x4a48e2,0x0,0x0,0x4a48e2,0x0,0x0,0x4a48e2,0x4a48e2,0x4a48e2,0x248e2,0x248e2,0x248e2,0x4a48e2,0x248e2,0x100000,0x248e2,0x248e2,};
   }
   private static void jj_la1_init_5() {
      jj_la1_5 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x1,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1fff,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000,0x0,0x0,0x2000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
