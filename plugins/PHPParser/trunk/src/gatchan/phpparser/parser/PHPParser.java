...
//{{{ namespace() method
  final public Namespace namespace() throws ParseException {
        ...
        int endLine;
        int endColumn;
    token = jj_consume_token(NAMESPACE);
    ...
    try {
      semicolon = jj_consume_token(SEMICOLON);
                ...
                {if (true) return new Namespace(expression,
                                     token.sourceStart,
                                     sourceEnd,
                                     token.beginLine,
                                     endLine,
...
//{{{ closureDeclaration()
  final public MethodDeclaration closureDeclaration() throws ParseException {
    ...
    FormalParameters(formalParameters);
                methodHeader = new MethodHeader(path,
                        null,
                        "",
                        false,
                        formalParameters,
