...
public final class Project
{
    ...
    public void load()
    {
        ...
        try
        {
            ...
            while (iterator.hasNext())
            {
                ...
                {
                    List<ClassHeader> list = (List<ClassHeader>) o;
                    for (int i = 0; i < list.size(); i++)
                    {
                        ClassHeader classHeader = list.get(i);
            ...
            while (iterator.hasNext())
            {
                ...
                {
                    List<InterfaceDeclaration> list = (List<InterfaceDeclaration>) o;
                    for (int i = 0; i < list.size(); i++)
                    {
                        InterfaceDeclaration interfaceDeclaration = list.get(i);
            ...
            while (iterator.hasNext())
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < list.size(); i++)
                    {
                        quickAccess.addToIndex(list.get(i));
                    }
                }
            }
    ...
    public void save()
    {
        ...
        {
            buff.append(excludedFolders.get(i)).append('\n');
        }
    ...
    public boolean isExcluded(String filePath)
    {
        for (int i = 0; i < excludedFolders.size(); i++)
        {
            String excludedPath = excludedFolders.get(i);
    ...
    private void insertItem(Map<String, Object> targetMap, PHPItem phpItem)
    {
        ...
        {
            ((List<PHPItem>) item).add(phpItem);
        }
        else
        {
            // The item is a PHPItem
            List<PHPItem> list = new ArrayList<PHPItem>();
