...
my $libName = `java -cp build/jar/hunspell.jar dk.swamp.dion.hunspell.HunspellMain -libname`;
...
sub untar() {
	...
	# TODO: Update to 1.2.2 or newer once windows support has been fixed.
