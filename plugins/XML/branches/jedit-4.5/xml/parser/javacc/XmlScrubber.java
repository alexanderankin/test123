/*
 * XmlScrubber.java -- cleans up HTML document tree.  
...
public class XmlScrubber extends XmlVisitor {
    ...
    public void visit(XmlDocument.Tag t) {
        ...
        for (Iterator it=t.attributeList.attributes.iterator(); it.hasNext(); ) {
            XmlDocument.Attribute a = (XmlDocument.Attribute) it.next();
    ...
    public void visit(XmlDocument.Text t)        {
        if (((flags & TRIM_SPACES) != 0)
                && !inPreBlock
                && (previousElement instanceof XmlDocument.Newline
                || previousElement instanceof XmlDocument.Tag
                || previousElement instanceof XmlDocument.EndTag
                || previousElement instanceof XmlDocument.Comment)) {
            int i;
    ...
    public void visit(XmlDocument.Comment c)     { previousElement = c; }
    public void visit(XmlDocument.Newline n)     { previousElement = n; }
    public void visit(XmlDocument.Annotation a)  { previousElement = a; }
