...
/**
 *  Describes an HTML entity; especial characters not normally allowed in HTML
 *  code, such as &amp;amp;
 *
 * @author     Andy Quick
 * @version    0.5
...
public class HtmlEntity {
    ...
    /**
     *  Look up the char code of an entity
     *
     * @param  entityName  The name of the entity, like &amp;amp;
     * @return             A char code corresponding to the entity
     */
    ...
    /**
     *  Look up an entity given a char code
     *
     * @param  code  The code of the entity we are looking for
    ...
    /**
     *  Puts an entity in its Hashtables to be looked up
     *
     * @param  code        The code for the entity
     * @param  entityName  The entity for the code
     */
