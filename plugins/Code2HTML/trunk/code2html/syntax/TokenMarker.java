...
//	public static final int MAJOR_ACTION_7 = 1 << 7;
    ...
    /**
     */
    public final static int ACTION_HINTS = 0x0000FF00;
    /**
     */
    public final static int AT_LINE_START = 1 << 9;
    /**
     */
    public final static int DELEGATE = 1 << 13;
    /**
     */
    public final static int EOL_SPAN = 1 << 4;
    /**
     */
    public final static int EXCLUDE_MATCH = 1 << 8;
    /**
     */
    public final static int IS_ESCAPE = 1 << 12;
    //{{{ Major actions (total: 8)
    /**
     */
    public final static int MAJOR_ACTIONS = 0x000000FF;
    /**
     */
    public final static int MARK_FOLLOWING = 1 << 3;
    /**
     */
    public final static int MARK_PREVIOUS = 1 << 2;
    /**
     */
    public final static int NO_LINE_BREAK = 1 << 10;
    /**
     */
    public final static int NO_WORD_BREAK = 1 << 11;
    /**
     */
    public final static int SPAN = 1 << 1;
    /**
     */
    public final static int WHITESPACE = 1 << 0;  //}}}

    //{{{ Private members
    private final static int SOFT_SPAN = MARK_FOLLOWING | NO_WORD_BREAK;
...
//	public static final int ACTION_HINT_15 = 1 << 15;
    ...
    /**
     *  Gets the main rule set of the object
     *
     * @return    The main rule set value
     */
    ...
    //{{{ getRuleSet() method
    /**
     *  Gets the rule set of the object
     *
     * @param  setName
    ...
    //{{{ addRuleSet() method
    /**
     *  Adds a feature to the rule set of the object
     *
     * @param  setName  The feature to be added to the rule set
     * @param  rules    The feature to be added to the rule set
     */
     ...
     * @param  tokenList
     * @return            true, keep checking other rules <br>
     *      false, stop checking other rules
     */
    ...
    public static class LineContext {
        ...
        /**
         *  Gets the allocation statistics of the object
         *
         * @return    The allocation statistics value
         */
