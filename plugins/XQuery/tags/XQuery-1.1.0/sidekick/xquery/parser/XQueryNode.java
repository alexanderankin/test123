...
public class XQueryNode extends Asset implements Comparable, SideKickElement {
    ...
    private TreeSet<XQueryNode> children = null;
    ...
    public void addChild(XQueryNode child) {
        if (child == null) {
            return;   
        }
        if (children == null) {
            children = new TreeSet<XQueryNode>();   
        }
        children.add(child);
    }
    ...
    public XQueryNode getFirstChild() {
    ...
    public Set<XQueryNode> getChildren() {
        return children;   
    }
