/*
 * TODO: THIS IS TEMPORARY. REMOVE THIS CLASS WHEN JEDIT 4.5 IS RELEASED. I copied 
 * this from the trunk of jEdit 4.5. I made changes to use the ColorWellButton
 * in this editorscheme.temporary package.  I want this capability before
 * jEdit 4.5 is released so I can release this plugin sooner.  This class becomes
 * duplicate code when 4.5 is released.
 */
...
package editorscheme.temporary;
...
public class StyleEditor extends EnhancedDialog implements ActionListener
{
	...
	private void initialize(Component comp, SyntaxStyle style, String styleName)
	{
		...
		fgColor = new editorscheme.temporary.ColorWellButton(fg);
		...
		bgColor = new editorscheme.temporary.ColorWellButton(bg);
	...
	private editorscheme.temporary.ColorWellButton fgColor;
	private JCheckBox bgColorCheckBox;
	private editorscheme.temporary.ColorWellButton bgColor;
	private JButton ok;
