...
public abstract class LookupAction extends EditAction {
	...
	// Lookup returned no tags
	protected void noTags(View view, String text) {
		JOptionPane.showMessageDialog(view,
			SourceNavigatorPlugin.getMessage("no-tags-found"));
	}
	// Lookup returned a single tag
	protected abstract void singleTag(View view, String text, DbRecord record);
	// Lookup returned multiple tags
	protected abstract void multipleTags(View view, String text,
	...
	public void invoke(View view) {
		...
		if (text == null || text.isEmpty()) {
			...
			if (msg == null)
				msg = "No tag selected or identified at the caret location.";
