...
/**
 * A default implementation of a <code>ASSourceIterator</code>
 * that uses an <code>InputStream</code> or a <code>Reader</code>
 * to read source code from.
 */
public class ASStreamIterator implements ASSourceIterator {
    ...
    public boolean hasMoreLines() {
        try { return inStream != null && inStream.ready(); }
        catch (IOException ioex) { return false; }
    }

    public String nextLine() {
        String line = null;
        try { line = inStream.readLine(); } catch (IOException ioex) { }
        if (line == null) {
