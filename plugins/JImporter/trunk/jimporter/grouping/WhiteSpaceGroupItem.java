 ...
 * @since 0.4
 */
public class WhiteSpaceGroupItem implements ImportGroupItem {
    ...
    public void store(int itemNumber) {
        jEdit.setProperty(ImportGroupOption.IMPORT_GROUP_VALUE_PREFIX + ".list." + itemNumber + ".type", "whitespace");
    }
}
