...
public class NimRODTheme extends DefaultMetalTheme {
  ...
  private void initFromProps( Properties props) {
    setPrimary1( parseColor( props.getProperty( "nimrodlf.p1"), null));                                                                 
    setPrimary2( parseColor( props.getProperty( "nimrodlf.p2"), null));                                                                 
    setPrimary3( parseColor( props.getProperty( "nimrodlf.p3"), null));                                                                 
                                                                     
    setSecondary1( parseColor( props.getProperty( "nimrodlf.s1"), null));                                                                 
    setSecondary2( parseColor( props.getProperty( "nimrodlf.s2"), null));                                                                 
    setSecondary3( parseColor( props.getProperty( "nimrodlf.s3"), null));                                                                 
                                                                     
    setWhite( parseColor( props.getProperty( "nimrodlf.w"), null));                                                                 
    setBlack( parseColor( props.getProperty( "nimrodlf.b"), null));                                                                 
	...
	//{{{ parseColor() method
	/**
	 * Borrowed from jEdit to handle color with alpha
	...
	public static Color parseColor(String name, Color defaultColor)
	{
		...
		if(name.charAt(0) == '#')
		{
			try
			{
			    ...
			    if (name.length() == 6)
			        name = "ff" + name;
			    java.math.BigInteger bi = new java.math.BigInteger(name, 16);
