/*
 * NimRODLookAndFeelPlugin.java - Look And Feel plugin
...
public class NimRODLookAndFeelPlugin extends EditPlugin {
    ...
    protected static void renameTheme( String oldName, String newName ) {
        if ( oldName == null || oldName.isEmpty() || newName == null || newName.isEmpty() ) {
            return;
        }
        try {
            File homeDir = jEdit.getPlugin( "lookandfeel.NimRODLookAndFeelPlugin" ).getPluginHome();
            File oldFile = new File( homeDir, oldName + ".properties" );
            File newFile = new File( homeDir, newName + ".properties" );
