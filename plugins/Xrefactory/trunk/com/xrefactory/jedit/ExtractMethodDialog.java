...
public class ExtractMethodDialog  extends JDialog {
	...
	public static class ExtractMethodPanel extends JPanel implements KeyListener {
		...
		ExtractMethodPanel(String invocation, String theHead, String theTail, int definitionLine) {
			super();
			int y;
...
&*/
	...
	public ExtractMethodDialog(String invocation, String theHead, String theTail, int targetLine) {
		super(s.view, "Xrefactory Extraction");
		setContentPane(new ExtractMethodPanel(invocation, theHead, theTail, targetLine));
		setModal(true);
		//&setSize(500,400);
		pack();
