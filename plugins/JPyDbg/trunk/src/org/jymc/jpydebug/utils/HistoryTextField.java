 ...
 * @author Slava Pestov
 * @version $Id: HistoryTextField.java,v 1.1 2006/01/10 22:50:25 ezust Exp $
 */
public class HistoryTextField extends JTextField
{
	...
	private void showPopupMenu(String text, int x, int y)
	{
		...
		JMenuItem caption = new JMenuItem("Previously Entered Strings");
		...
		MiscStatic.showPopupMenu(popup,this,x,y,false);
	} //}}}
