 ...
 * @author Slava Pestov
 * @version $Id: HistoryModel.java,v 1.1 2006/01/10 22:50:25 ezust Exp $
 */
public class HistoryModel extends AbstractListModel
{
	...
	{
		String settingsDirectory = PythonDebugParameters.ideFront.getSettingsDirectory();
		if(settingsDirectory == null)
			return;

		history = new File(PythonDebugParameters.ideFront.constructPath(
		...
		try
		{
			...
			while((line = in.readLine()) != null)
			{
				...
				{
					currentModel.data.addElement(MiscStatic
						.escapesToChars(line));
				}
			}
	...
	public static void saveHistory()
	{
	  ...
	  //Log.log(Log.MESSAGE,HistoryModel.class,"Saving history");
		File file1 = new File(PythonDebugParameters.ideFront.constructPath(
			PythonDebugParameters.ideFront.getSettingsDirectory(), "#history"));
		...
		try
		{
			...
			if(models != null)
			{
				...
				while(modelEnum.hasMoreElements())
				{
					...
					out.write('[');
					out.write(MiscStatic.charsToEscapes(
