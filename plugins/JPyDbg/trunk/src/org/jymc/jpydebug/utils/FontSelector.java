 ...
 * @author Slava Pestov
 * @version $Id: FontSelector.java,v 1.1 2006/01/10 22:50:25 ezust Exp $
 */
public class FontSelector extends JButton
{
	 ...
	 */
	private JDialog getParentDialog(Component c)
	{
	...
	class ActionHandler implements ActionListener
	{
		public void actionPerformed(ActionEvent evt)
		{
			...
			JDialog dialog = getParentDialog(FontSelector.this);
			if(dialog == null)
			{
