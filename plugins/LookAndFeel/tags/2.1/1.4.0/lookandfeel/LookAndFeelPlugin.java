...
public class LookAndFeelPlugin extends EditPlugin {
	...
	public void start() {
		try {
			...
			installLookAndFeel( LnfInstaller.createInstaller( lnf ) );
	 ...
	 */
	public static void installLookAndFeel( final LnfInstaller installer ) {
		SwingUtilities.invokeLater( new Runnable() {
			        public void run() {
				        try {
					        ...
					        if ( jEdit.getBooleanProperty( "lookandfeel.usejeditfont",
					                false ) ) {
	 ...
	 * This method ignores frames because all frames should be handled from
	 * {@link updateAllComponentTreeUIs()}.
	 */
