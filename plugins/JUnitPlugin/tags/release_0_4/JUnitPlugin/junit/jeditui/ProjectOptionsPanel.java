...
implements ActionListener, ListSelectionListener {
        ...
        //{{{ constructor
        /**
        * Creates a new ProjectOptionsPanel.<p>
        *
        ...
        */
        ...
        public void _init() { 
                ...
                addButtonText = jEdit.getProperty(
                        "junit.add-button-text") + "...";
                removeButtonText = jEdit.getProperty(
                        "junit.remove-button-text");
                moveUpButtonText = jEdit.getProperty(
                        "junit.move-up-button-text");
                moveDownButtonText = jEdit.getProperty( 
                        "junit.move-down-button-text");
                fileDialogTitle = jEdit.getProperty("junit.file-dialog-title");
                fileDialogAction = jEdit.getProperty(
                        "junit.file-dialog-action");
        ...
        */
        public void setPath(String path) {
                ...
                if(elements.size() > 0) {
                        pathElementModel.fireTableRowsInserted(0, 
                                elements.size() - 1);
                        pathElementTable.setRowSelectionInterval(0, 0);
                }
        }
