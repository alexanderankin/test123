...
public class ConstantsChooser {
   ...
   private static Vector col_names = null;
    ...
    */
   private static Vector getData( JMenu menu ) {
         ...
         for ( int i = 0; i < constants.length; i++ ) {
            try {
               ...
               if ( fr.isConstant() ) {
                  ...
                  row.addElement( new Boolean( menu_commands.contains( fr.getCommand() ) ) );
                  row.addElement( name );
                  row.addElement( value );
                  row.addElement( uncertainty );
                  row.addElement( units );
                  rows.addElement( row );
   ...
   public static void showChooser( JComponent parent, final JMenu constants_menu, final ActionListener listener ) {
      ...
      col_names.addElement( "On Menu" );
      col_names.addElement( "Constant" );
      col_names.addElement( "Value" );
      col_names.addElement( "Uncertainty" );
      col_names.addElement( "Units" );
