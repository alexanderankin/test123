...
public class ClassHierarchy extends JPanel implements DefaultFocusComponent {
	...
	public ClassHierarchy(View view) {
		...
		topPanel.add(BorderLayout.NORTH, toolbar);
	...
	private void setMembers(String clazz) {
	...
	private void buildToolbar() {
		...
		ActionListener l = new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				boolean superType;
				if (e.getSource() == superTypeHierButton) {
					superType = superTypeHierButton.isSelected();
					subTypeHierButton.setSelected(!superType);
				} else {
					superType = (!subTypeHierButton.isSelected());
					superTypeHierButton.setSelected(superType);
				}
				updateTree();
			}
		};
		...
		toolbar.add(superTypeHierButton);
		toolbar.add(subTypeHierButton);
	}
