...
@SuppressWarnings(value = "DM_GC",
                  justification = "Garbage Collection is needed to eventually free the DLL if it is blocked by a \"dead\" ClassLoaded")
@ThreadSafe
public class WincryptCipher implements Cipher {
    ...
    @GuardedBy("this") private char[] description;
    ...
    public synchronized void setAdditionalInformation(@Nullable Object... additionalInformation) {
        if ((null == additionalInformation) ||
            ...
            description = new char[0];
        } else if ((1 != additionalInformation.length) ||
                   !(additionalInformation[0] instanceof String)) {
