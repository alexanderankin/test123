...
public class PackageBrowser {
    ...
    public static void parse() {
        ...
        if (parsed == false) {
            ...
            for (int i = 0; i < classpath.length; ++i) {
                ...
                //Log.log(Log.DEBUG, PackageBrowser.class, classpath[i] );
    ...
    private static void parseJAR(File jar) {
        ...
        try {
            //Log.log(Log.DEBUG, PackageBrowser.class, "archive: " + jar.getAbsolutePath() );
            ...
            while( elements.hasMoreElements() ) {
                ...
                if (jar.getName().equals("classes.zip") ) {
                    Log.log(Log.DEBUG, PackageBrowser.class, entry.getName() );
                }
                */
                ...
                if ( ext != null && ext.equals("class") ) {
                    ...
                    //Log.log(Log.DEBUG, PackageBrowser.class, getPackage( entry.getName() ) );
                }
