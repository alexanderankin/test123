 ...
 *
 * @author Slava Pestov
 * @version $Id: SyntaxDocument.java 62 2004-03-25 03:11:13Z danson $
 */
public class SyntaxDocument extends PlainDocument {
    ...
    public SyntaxDocument( FileMap fileMap ) {
        ...
        for ( long lineNumber : lineDetails.keySet() ) {
            FileMap.LineDetails details = lineDetails.get( lineNumber );
            lineElements[ ( int ) lineNumber ] = createLeafElement( root, null, ( int ) details.lineStartOffset, ( int ) details.lineEndOffset );
        }
        root.replace( 0, root.getElementCount(), lineElements );
    }
