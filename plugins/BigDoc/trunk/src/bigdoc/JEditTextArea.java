 ...
 *
 * @author Slava Pestov
 * @version $Id: JEditTextArea.java 98 2004-05-24 04:10:50Z danson $
 */
public class JEditTextArea extends JComponent {
    ...
    public void updateScrollBars() {
        ...
        if (statusBar != null) {
            statusBar.setLine(getCaretLine(), getLineCount() - 1);
        }
    ...
    public final void getText( int start, int len, Segment segment ) {
        try {
            document.getText( start, Math.max( 0, len ), segment );
        }
        catch ( BadLocationException bl ) {
            bl.printStackTrace();
    ...
    class MouseHandler extends MouseAdapter {
        ...
        int offset, int dot ) throws BadLocationException {
            ...
            .isLetterOrDigit( ch ) && noWordSep.indexOf( ch ) == -1 );
