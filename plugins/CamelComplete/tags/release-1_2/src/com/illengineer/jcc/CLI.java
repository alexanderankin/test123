...
public class CLI
{
	...
	if (!parseError) {
	    ...
	    if (fileName == null && jarFileName == null && loadSerialName == null)
		parseError = true;
	}
	...
	if (filterRegex != null)
	    debugPrint("Filtering regexp is: " + filterRegex);
	if (fileName != null)
	    ctagsFile = new File(fileName);
	if (jarFileName != null)
	    jarFile = new File(jarFileName);
	if (loadSerialName != null)
	    serialFile = new File(loadSerialName);
