...
public abstract class ComplexVFS extends SqlSubVFS
{
	 ...
	 *@since
	 */
	public VFS.DirectoryEntry _getDirectoryEntry( Object session, VFSObjectRec rec,
	                                              Component comp, int level )
		throws IOException
	{
		Log.log( Log.DEBUG, ComplexVFS.class, "Getting entry for [" + rec.path + "]/[" + rec.size + "]" );
		return new SqlDirectoryEntry( rec, level == OBJECT_LEVEL ?
