...
public class OracleVFS extends SqlSubVFS
{
  ...
  public VFS.DirectoryEntry[] _listDirectory( Object session, String path,
      Component comp, SqlServerRecord rec, int level )
       throws IOException
  {
    Log.log( Log.DEBUG, OracleVFS.class,
        "Listing " + path );
      ...
      boolean ignoreErrors, Component comp, int level ) throws IOException
  {
    ...
    if ( ot == null )
      return null;
    final String userName = SqlVFS.getPathComponent( path, OracleVFS.SCHEMA_LEVEL );
    if ( userName == null )
      return null;
    final String objName = SqlVFS.getPathComponent( path, OracleVFS.OBJECT_LEVEL );
    if ( objName == null )
      return null;
  ...
  /**
   *  Gets the ObjectType attribute of the OracleVFS object
   *
   * @param  path  Description of Parameter
  ...
  static
  {
    objectTypes.put( "Functions",
        new CodeObjectType( "FUNCTION" ) );
    objectTypes.put( "Procedures",
        new CodeObjectType( "PROCEDURE" ) );
    objectTypes.put( "Packages",
    ...
    objectTypes.put( "Views",
        new TableObjectType( "selectViewsInSchema" ) );

    objectTypes.put( "Triggers",
