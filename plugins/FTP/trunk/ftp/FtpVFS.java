...
public class FtpVFS extends VFS
{
	...
	static class FtpDirectoryEntry extends VFSFile
	{
		...
		FtpDirectoryEntry(String name, String path,
		...
		public String getExtendedAttribute(String name)
		{
			...
			if (name.equals(FtpVFS.EA_OWNER_GROUP))
				return ownerGroup;
			if(name.equals(VFS.EA_MODIFIED))
		...
		public void setOwner(String name, String group) {
			ownerUser = name==null || name.isEmpty() ? null : name;
			ownerGroup = group==null || group.isEmpty() ? null : group;
		}
	...
	public boolean _rename(Object _session, String from, String to, Component comp) throws IOException
	{
		...
		if(directoryEntry != null && directoryEntry.getType() == VFSFile.FILE && !address.getPath().equalsIgnoreCase(toPath))
		{
	...
	throws IOException
	{
		...
		String[] nameArray = { entry.getName() };
